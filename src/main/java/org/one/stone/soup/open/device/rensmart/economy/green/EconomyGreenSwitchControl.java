package org.one.stone.soup.open.device.rensmart.economy.green;
...
import org.one.stone.soup.open.device.kmtronic.relay.controller.RelayController;
...
public class EconomyGreenSwitchControl implements SwitchControl,Switch {
	...
	public EconomyGreenSwitchControl(Connection connection) throws Exception {
		relayController = new RelayController(connection);

package org.one.stone.soup.open.device.kmtronic.relay.controller;
...
public class RelayController implements SwitchControl {
	...
	public RelayController(Connection connection) throws Exception
	{
